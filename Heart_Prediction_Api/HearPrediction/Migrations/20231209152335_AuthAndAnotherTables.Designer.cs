...
namespace HearPrediction.Api.Migrations
{
    ...
    [Migration("20231209152335_AuthAndAnotherTables")]
    partial class AuthAndAnotherTables
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HearPrediction.Api.Model.MedicalTest", b =>
                {
                    ...
                    b.Property<string>("RefferenceRange")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("HearPrediction.Api.Model.Doctor", b =>
                {
                    b.HasOne("HearPrediction.Api.Model.Reciptionist", null)
                        .WithMany("Doctors")
